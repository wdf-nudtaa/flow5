...
#include <fl5/core/stlreaderdlg.h>
...
#include <fl5/interfaces/editors/analysis3ddef/aerodatadlg.h>
#include <fl5/interfaces/editors/analysis3ddef/extradragdlg.h>
...
#include <fl5/interfaces/editors/fuseedit/flatfaceconverterdlg.h>
...
#include <fl5/interfaces/editors/fuseedit/shapefixerdlg.h>
...
#include <fl5/interfaces/editors/inertia/planestlinertiadlg.h>
#include <fl5/interfaces/editors/inertia/planexflinertiadlg.h>
#include <fl5/interfaces/editors/planeedit/planestldlg.h>
#include <fl5/interfaces/editors/planeedit/planexfldlg.h>
#include <fl5/interfaces/editors/translatedlg.h>
#include <fl5/interfaces/editors/wingedit/wingdefdlg.h>
#include <fl5/interfaces/editors/wingedit/wingobjectdlg.h>
...
#include <fl5/interfaces/exchange/wingexportdlg.h>
...
#include <fl5/modules/xplane/analysis/batchplanedlg.h>
#include <fl5/modules/xplane/analysis/batchxmldlg.h>
#include <fl5/modules/xplane/analysis/lltanalysisdlg.h>
...
#include <fl5/modules/xplane/controls/targetcurvedlg.h>
#include <fl5/modules/xplane/controls/wingseldlg.h>
#include <fl5/modules/xplane/controls/xplanewt.h>
#include <fl5/modules/xplane/glview/gl3dxplaneview.h>
#include <fl5/modules/xplane/glview/glxplanebuffers.h>
...
//    m_iActiveT7Mode = -1;
    ...
    QStringList XPOppList = {"y ("+QUnits::lengthUnitLabel() +")"};
...
PlaneOpp *XPlane::storePOpps(std::vector<PlaneOpp*> const &POppList)
{
...
void XPlane::onPickedNodePair(QPair<int, int> nodepair)
{
    ...
    QString strange;
    strange += QString::asprintf("   distance = %13g ", seg.length()*Units::mtoUnit()) + QUnits::lengthUnitLabel() + "\n";
    strange += QString::asprintf("         dx = %13g ", seg.segment().x*Units::mtoUnit()) + QUnits::lengthUnitLabel() + "\n";
    strange += QString::asprintf("         dy = %13g ", seg.segment().y*Units::mtoUnit()) + QUnits::lengthUnitLabel() + "\n";
    strange += QString::asprintf("         dz = %13g ", seg.segment().z*Units::mtoUnit()) + QUnits::lengthUnitLabel() + "\n\n";
    displayMessage(strange, true, false);
}
...
void XPlane::exportMainDataToString(PlaneOpp const *pPOpp, Plane const*pPlane, QString &poppdata, xfl::enumTextFileType filetype, QString const &textsep) const
{
    ...
    QString inertia = QUnits::inertiaUnitLabel();
    ...
    strange = QString("mass("+QUnits::massUnitLabel()+")").rightJustified(17, ' ');     poppdata += strange+sep;
            ...
            if(iw<pPOpp->nWOpps())
            {
                ...
                if(pPOpp->WOpp(iw).m_FlapMoment.size())
                {
                    ...
                    for (int l=0; l<pPOpp->WOpp(iw).m_nFlaps; l++)
                    {
                        ...
                        strange += QUnits::momentUnitLabel();
                        poppdata += strange +"\n";
                    }
                    poppdata += "\n";
                }
    ...
    title  = QString("y("+QUnits::lengthUnitLabel()+")").rightJustified(17, ' ') + sep;
