...
#include <fl5/interfaces/editors/analysis2ddef/foilpolardlg.h>
#include <fl5/interfaces/editors/analysis2ddef/polarautonamedlg.h>
#include <fl5/interfaces/editors/analysisseldlg.h>
#include <fl5/interfaces/editors/editplrdlg.h>
#include <fl5/interfaces/editors/foiledit/foil1splinedlg.h>
#include <fl5/interfaces/editors/foiledit/foil2splinedlg.h>
#include <fl5/interfaces/editors/foiledit/foilcamberdlg.h>
#include <fl5/interfaces/editors/foiledit/foilcoorddlg.h>
#include <fl5/interfaces/editors/foiledit/foilflapdlg.h>
#include <fl5/interfaces/editors/foiledit/foilledlg.h>
#include <fl5/interfaces/editors/foiledit/foilnacadlg.h>
#include <fl5/interfaces/editors/foiledit/foilnormalizedlg.h>
#include <fl5/interfaces/editors/foiledit/foilrepaneldlg.h>
#include <fl5/interfaces/editors/foiledit/foilscaledlg.h>
#include <fl5/interfaces/editors/foiledit/foiltegapdlg.h>
#include <fl5/interfaces/editors/foiledit/interpolatefoilsdlg.h>
#include <fl5/interfaces/graphs/containers/graphwt.h>
#include <fl5/interfaces/graphs/controls/graphdlg.h>
#include <fl5/interfaces/graphs/controls/graphoptions.h>
#include <fl5/interfaces/graphs/controls/graphtilevariableset.h>
#include <fl5/interfaces/graphs/globals/graph_globals.h>
#include <fl5/interfaces/graphs/graph/curve.h>
#include <fl5/interfaces/graphs/graph/graph.h>
#include <fl5/interfaces/optim/optimfoildlg.h>
#include <fl5/interfaces/view2d/foilsvgwriter.h>
...
#include <fl5/interfaces/widgets/customdlg/textdlg.h>
#include <fl5/interfaces/widgets/customwts/cptableview.h>
#include <fl5/interfaces/widgets/customwts/floatedit.h>
#include <fl5/interfaces/widgets/line/linemenu.h>
#include <fl5/modules/xdirect/analysis/analysis2dsettings.h>
#include <fl5/modules/xdirect/analysis/xfoilanalysisdlg.h>
#include <fl5/modules/xdirect/analysis/xfoilbatchdlg.h>
#include <fl5/modules/xdirect/controls/analysis2dctrls.h>
#include <fl5/modules/xdirect/controls/foiltableview.h>
#include <fl5/modules/xdirect/controls/foiltreeview.h>
#include <fl5/modules/xdirect/controls/lecircledlg.h>
#include <fl5/modules/xdirect/controls/oppointctrls.h>
#include <fl5/modules/xdirect/graphs/blgraphctrls.h>
#include <fl5/modules/xdirect/graphs/xdirectlegendwt.h>
#include <fl5/modules/xdirect/menus/xdirectactions.h>
#include <fl5/modules/xdirect/menus/xdirectmenus.h>
#include <fl5/modules/xdirect/mgt/foilplrlistdlg.h>
#include <fl5/modules/xdirect/view2d/dfoillegendwt.h>
#include <fl5/modules/xdirect/view2d/dfoilwt.h>
#include <fl5/modules/xdirect/view2d/oppointwt.h>
    ...
    switch(pGraph->yVariable(0))
    {
        case 0:  // Cp
        {
            ...
            for (int j=0; j<pOpFoil->nNodes(); j++)
            {
                ...
                if(pOpp==curOpp() && pCpi)  pCpi->appendPoint(pOpFoil->x(j), pOpp->m_Cpi.at(j));
            }
...
void XDirect::loadSettings(QSettings &settings)
{
    ...
    {
        XFoilTask::setAutoInitBL(   settings.value("AutoInitBL",  XFoilTask::bAutoInitBL()).toBool());
        XFoilTask::setMaxIterations(settings.value("IterLim",     XFoilTask::maxIterations()).toInt());
        XFoilTask::setStoreOpps(    settings.value("StoreOpp",    XFoilTask::bStoreOpps()).toBool());
        XFoilTask::setAoAAnalysis(  settings.value("AlphaSpec",   XFoilTask::bAlpha()).toBool());
        XFoilTask::setViscous(      settings.value("Viscous",     XFoilTask::bViscous()).toBool());
        XFoilTask::setInitBL(       settings.value("InitBL",      XFoilTask::bInitBL()).toBool());
...
{
    Objects2d::setPolarStyle(curPolar(), curPolar()->theStyle(), true, true, true, true, false, xfl::darkFactor());
...
void XDirect::onDeleteCurPolar()
{
    ...
    str = "Are you sure you want to delete the polar :\n  " + QString::fromStdString(Objects2d::curPolar()->name());
    ...
    Polar *pNextPolar = Objects2d::polar(curFoil(), nextPolarName.toStdString());
    setPolar(pNextPolar);
...
void XDirect::onExportCurFoilToDat()
{
    ...
    QString FileName;
    FileName = QString::fromStdString(curFoil()->name());
    FileName.replace("/", " ");
    ...
    curFoil()->exportFoilToDat(outstring);
...
void XDirect::onExportCurFoilToSVG()
{
    ...
    QString FileName = QString::fromStdString(curFoil()->name());
    FileName.replace("/", " ");
    FileName = QFileDialog::getSaveFileName(s_pMainFrame, "Export Foil",
...
void XDirect::onExportCurOpp()
{
    ...
    QString FileName = QString::fromStdString(curOpp()->name());
...
void XDirect::onExportPolarOpps()
{
    ...
    out<<"\n\n";
    strong = QString::fromStdString(curFoil()->name() + "\n");
    out << strong;
...
void XDirect::onExportCurPolar()
{
    ...
    FileName = QString::fromStdString(Objects2d::curPolar()->name());
    FileName.replace("/", " ");
...
QString XDirect::onCopyCurOppData()
{
    ...
    std::string strout;
    curOpp()->exportOpp(strout, xfl::versionName(true).toStdString(), SaveOptions::exportFileType()==xfl::CSV, SaveOptions::textSeparator().toStdString());
...
void XDirect::onRenameCurPolar()
{
    ...
    QString OldName = QString::fromStdString(Objects2d::curPolar()->name());
    ...
    while (bExists)
    {
        ...
        if(resp==QDialog::Accepted)
        {
            ...
            if(!bExists)
            {
                ...
                Objects2d::renamePolar(curPolar(), renameDlg.newName().toStdString());
            }
            emit projectModified();
        }
        else if(resp ==10)
...
//                    bExists = true;
            ...
            Objects2d::curPolar()->setName(renameDlg.newName().toStdString());
...
void XDirect::onPolarProps()
{
    ...
    ObjectPropsDlg *pOPDlg = new ObjectPropsDlg(s_pMainFrame);
    std::string strangeProps;
    strangeProps = Objects2d::curPolar()->properties();
...
void XDirect::onOpPointProps()
{
    ...
    ObjectPropsDlg *pOPDlg = new ObjectPropsDlg(s_pMainFrame);
    std::string strangeProps;
    strangeProps = curOpp()->properties(SaveOptions::textSeparator().toStdString());
...
void XDirect::onSavePolars()
{
    ...
    QString FileName;
    FileName = QString::fromStdString(curFoil()->name()) + ".plr";
    FileName.replace("/", " ");
...
void XDirect::saveSettings(QSettings &settings)
{
    ...
    settings.beginGroup("XFoilTask");
    {
        settings.setValue("AutoInitBL",  XFoilTask::bAutoInitBL());
        settings.setValue("IterLim",     XFoilTask::maxIterations());
        settings.setValue("StoreOpp",    XFoilTask::bStoreOpps());
        settings.setValue("AlphaSpec",   XFoilTask::bAlpha());
        settings.setValue("Viscous",     XFoilTask::bViscous());
        settings.setValue("InitBL",      XFoilTask::bInitBL());
...
//    setPolar();
    if(curFoil())
    {
        m_pOpPointWt->setFoilData(QString::fromStdString(curFoil()->properties(false)));
    }
...
{
    std::string oldName = curFoil()->name();
...
void XDirect::onSetFoilDescription()
{
    ...
    TextDlg dlg(QString::fromStdString(Objects2d::curFoil()->description()), s_pMainFrame);

    if(dlg.exec() != QDialog::Accepted) return;
    Objects2d::curFoil()->setDescription(dlg.newText().toStdString());
