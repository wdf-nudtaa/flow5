...
class OpPointWt : public QWidget
{
    ...
    public:
        ...
        static void showNeutralLine(bool b) {s_bNeutralLine=b;}
        static bool bNeutralLine() {return s_bNeutralLine;}
    ...
    public:
        ...
        static void setNeutralLineColor(QColor const&clr);
