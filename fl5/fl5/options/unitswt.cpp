...
void UnitsWt::initWidget()
{
    ...
    for(int i=0; i<4; i++)
    {
        strange = QUnits::forceUnitLabel(i);
...
void UnitsWt::onFluidUnit()
{
    ...
    Units::setUnitConversionFactors();
    m_plabFluidUnit->setText("Density:             " + QUnits::densityUnitLabel()   +"\n" +
                             "Kinematic viscosity: " + QUnits::viscosityUnitLabel() +"\n");
...
void UnitsWt::setLabels()
{
    ...
    int len1 = 11;
    int len2 = 17;
    strUnitLabel = QUnits::lengthUnitLabel();
    ...
    strUnitLabel = QUnits::areaUnitLabel();
    ...
    strUnitLabel = QUnits::speedUnitLabel();
    ...
    strUnitLabel = QUnits::massUnitLabel();
    ...
    strUnitLabel = QUnits::forceUnitLabel();
    ...
    strUnitLabel = QUnits::momentUnitLabel();
    ...
    strUnitLabel = QUnits::pressureUnitLabel();
    ...
    strUnitLabel = QUnits::inertiaUnitLabel();
