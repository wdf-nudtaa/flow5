...
#include <fl5/interfaces/editors/inertia/planeinertiamodel.h>
...
#include <fl5/interfaces/widgets/customdlg/stringvaluedlg.h>
...
void PlaneXflInertiaDlg::onCopyInertiaToClipboard()
{
    ...
    strInertia += "   Ixx (" + QUnits::inertiaUnitLabel() + ")" + sep;
    strInertia += "   Iyy (" + QUnits::inertiaUnitLabel() + ")" + sep;
    strInertia += "   Izz (" + QUnits::inertiaUnitLabel() + ")" + sep;
    strInertia += "   Ixz (" + QUnits::inertiaUnitLabel() + ")" + sep;
    strInertia += "\n";
