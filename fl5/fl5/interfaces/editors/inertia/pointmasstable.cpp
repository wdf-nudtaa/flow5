...
PointMassTable::PointMassTable(QWidget *pParent) : CPTableView(pParent)
{
    ...
    m_pMassModel->setHeaderData(0, Qt::Horizontal, "Mass ("+QUnits::massUnitLabel()   +")");
    m_pMassModel->setHeaderData(1, Qt::Horizontal, "x ("   +QUnits::lengthUnitLabel() +")");
    m_pMassModel->setHeaderData(2, Qt::Horizontal, "y ("   +QUnits::lengthUnitLabel() +")");
    m_pMassModel->setHeaderData(3, Qt::Horizontal, "z ("   +QUnits::lengthUnitLabel() +")");
