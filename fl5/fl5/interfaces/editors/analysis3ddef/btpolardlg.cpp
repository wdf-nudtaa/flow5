...
#include <fl5/interfaces/editors/analysis3ddef/btpolarnamemaker.h>
...
//    m_pBtVariableModel->blockSignals(true);
    ...
    m_pBtVariableModel->setData(ind, QUnits::speedUnitLabel());
...
void BtPolarDlg::setupLayout()
{
    ...
    QFrame *pInertiaFrame = new QFrame;
    {
        QGridLayout *pInertiaDataLayout = new QGridLayout;
        {
            ...
            QLabel *plabLengthUnit1 = new QLabel(QUnits::lengthUnitLabel());
            QLabel *plabLengthUnit2 = new QLabel(QUnits::lengthUnitLabel());
            QLabel *plabLengthUnit3 = new QLabel(QUnits::lengthUnitLabel());
    ...
    m_plabWakeLengthLabUnit->setText(QUnits::lengthUnitLabel());
}
