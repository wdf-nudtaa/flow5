...
#include <fl5/interfaces/editors/importobjectdlg.h>
#include <fl5/interfaces/editors/inertia/partinertiadlg.h>
#include <fl5/interfaces/editors/inertia/planexflinertiadlg.h>
#include <fl5/interfaces/editors/planeedit/planepartdelegate.h>
#include <fl5/interfaces/editors/planeedit/planepartmodel.h>
...
#include <fl5/interfaces/mesh/tesscontrolsdlg.h>
                                    ...
                                    QGroupBox * pCuttingWingsBox = new QGroupBox("Cutting wings");
                                    {
                                        QVBoxLayout *pCuttingWingsLayout = new QVBoxLayout;
                                        {
                                            ...
                                            QGridLayout *pAssyParamLayout = new QGridLayout;
                                            {
                                                ...
                                                QLabel *pLabLength1 = new QLabel(QUnits::lengthUnitLabel());
...
void PlaneXflDlg::onInsertSTLCylinderFuse()
{
    DoubleValueDlg dlg(this, {2.0*Units::mtoUnit(), 0.1*Units::mtoUnit(), 37, 31}, {"Length", "Radius", "Ny", "NHoop"},
                       {QUnits::lengthUnitLabel(), QUnits::lengthUnitLabel(), QString(), QString()});
...
void PlaneXflDlg::onInsertEllipticWing()
{
    DoubleValueDlg dlg(this, {0.3*Units::mtoUnit(), 3.0*Units::mtoUnit(), 15},
                             ...
                             {QUnits::lengthUnitLabel(), QUnits::lengthUnitLabel(), QString()});
    if(dlg.exec()!=QDialog::Accepted)  return;
    ...
    switch(iNewTab)
    {
        ...
        case 3:
        {
            ...
            else
            {
                ...
                m_pGMesherWt->initWt(pFuse, pFuse->isXflType());
...
void PlaneXflDlg::onSelMesher()
{
    FuseOccDlg::setfl5Mesher(m_prbfl5Mesher->isChecked());
    m_pMesherWt->setVisible(FuseOccDlg::bfl5Mesher());
    m_pGMesherWt->setVisible(!FuseOccDlg::bfl5Mesher());
}
...
void PlaneXflDlg::onInsertCADShape()
{
    ...
    if(pSenderAction==m_pInsertCADCylinder)
    {
        DoubleValueDlg dlg(this, {2.0*Units::mtoUnit(), 0.1*Units::mtoUnit()}, {"Length", "Radius"},
                           {QUnits::lengthUnitLabel(), QUnits::lengthUnitLabel()});
        if(dlg.exec()!=QDialog::Accepted) return;
    ...
    {
        DoubleValueDlg dlg(this, {1.0*Units::mtoUnit()}, {"Radius"}, {QUnits::lengthUnitLabel()});
        if(dlg.exec()!=QDialog::Accepted) return;
    ...
    else if(pSenderAction==m_pInsertCADBox)
    {
        DoubleValueDlg dlg(this, {1.0*Units::mtoUnit(), 1.0*Units::mtoUnit(), 1.0*Units::mtoUnit()}, {"Length", "Width", "Height"},
                           {QUnits::lengthUnitLabel(), QUnits::lengthUnitLabel(), QUnits::lengthUnitLabel()});
        if(dlg.exec()!=QDialog::Accepted) return;
