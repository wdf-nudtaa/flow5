...
#include <fl5/interfaces/mesh/gmesher.h>
...
void GMesherWt::setupLayout()
{
    QVBoxLayout *pMainLayout = new QVBoxLayout;
    {
        QGridLayout*pMeshOptionLayout = new QGridLayout;
        {
            ...
            QLabel *plabLength2 = new QLabel(QUnits::lengthUnitLabel());
...
bool GMesherWt::readMeshSize()
{
    ...
    if(size<MINSIZE)
    {
        QString str = QString::asprintf("%g", MINSIZE*Units::mtoUnit()) + QUnits::lengthUnitLabel();
