...
#include <fl5/interfaces/opengl/fl5views/gl3dparetoview.h>
...
#include <fl5/interfaces/widgets/customwts/xfltreeview.h>
...
void OptimPlaneDlg::getUnit(int ivar, double &factor, QString &labunit) const
{
    ...
    else if(ivar==1)
    {
        ...
        labunit = QUnits::massUnitLabel();
    }
    else if(ivar==2 || ivar==3)
    {
        factor  = Units::mtoUnit();
        labunit = QUnits::lengthUnitLabel();
    }
    else
    {
