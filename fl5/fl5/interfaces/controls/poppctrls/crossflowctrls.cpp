...
{
    //wake
    m_pLabLen2->setText(QUnits::lengthUnitLabel());
}
        ...
        QGroupBox *pPlaneGeomBox = new QGroupBox("Crossflow plane geometry");
        {
            QVBoxLayout *pPlaneGeomLayout = new QVBoxLayout;
            {
                QHBoxLayout *pXPosLayout = new QHBoxLayout;
                {
                    ...
                    m_pLabLen1 = new QLabel(QUnits::lengthUnitLabel());
                ...
                {
                    m_pLabLen2  = new QLabel(QUnits::lengthUnitLabel());
...
void CrossFlowCtrls::makeXPlaneVelocityVectors()
{
    ...
    m_pLabLen1->setText(QString::asprintf("%.2f", xmax*Units::mtoUnit()*1.1)+QUnits::lengthUnitLabel());
