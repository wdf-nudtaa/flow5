...
/**
* Draws the spline normals on a QPainter.
*/
...
*/
void drawCtrlPoints(Spline const *pSpline, QPainter &painter, double scalex, double scaley, QPointF const &Offset, QColor const& backclr)
{
    if(!pSpline) return;
...
*/
void drawOutputPoints(Spline const *pSpline, QPainter & painter, double scalex, double scaley, QPointF const &Offset,
 ...
 */
void drawSpline(Spline const *pSpline, QPainter & painter, double scalex, double scaley, QPointF const &Offset)
{
    if(!pSpline) return;
    if(!pSpline->isVisible()) return;
