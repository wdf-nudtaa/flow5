...
void XPlaneActions::makeActions()
{
    ...
    m_pEditWingDef->setData(WingXfl::Main);
    ...
    m_pEditStabObject->setData(WingXfl::Elevator);
    ...
    m_pEditFinDef->setData(WingXfl::Fin);
    ...
    m_pEditFinObject->setData(WingXfl::Fin);
    ...
    m_pScaleWing->setData(WingXfl::Main);
    ...
    m_pScaleStab->setData(WingXfl::Elevator);
    ...
    m_pScaleFin->setData(WingXfl::Fin);
...
void XPlaneActions::makeExportActions()
{
    ...
    m_pExportWingXml->setData(WingXfl::Main);
    ...
    m_pExportWingCAD->setData(WingXfl::Main);
    ...
    m_pExportWingTessToStl->setData(WingXfl::Main);
    ...
    m_pExportWingMeshToStl->setData(WingXfl::Main);
    ...
    m_pExportStabXml->setData(WingXfl::Elevator);
    ...
    m_pExportStabCAD->setData(WingXfl::Elevator);
    ...
    m_pExportStabTessToStl->setData(WingXfl::Elevator);
    ...
    m_pExportStabMeshToStl->setData(WingXfl::Elevator);
    ...
    m_pExportFinXml->setData(WingXfl::Fin);
    ...
    m_pExportFinCAD->setData(WingXfl::Fin);
    ...
    m_pExportFinTessToStl->setData(WingXfl::Fin);
    ...
    m_pExportFinMeshToStl->setData(WingXfl::Fin);
