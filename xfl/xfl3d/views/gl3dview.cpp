...
void gl3dView::paintAxes()
{
    ...
    glRenderText(1.0, 0.015, 0.015, m_AxisTitle[0], DisplayOptions::textColor());
    glRenderText(0.015, 1.0, 0.015, m_AxisTitle[1], DisplayOptions::textColor());
    glRenderText(0.015, 0.015, 1.0, m_AxisTitle[2], DisplayOptions::textColor());
}
...
{
    paintSegments(vbo, ls.m_Color, float(ls.m_Width), ls.m_Stipple, bHigh);
}
...
{
    paintThinArrow(origin, arrow, ls.m_Color, float(ls.m_Width), ls.m_Stipple, ModelMatrix);
}
...
void gl3dView::glMakeIcosahedron()
{
    ...
    QVector<Triangle3d> triangle(20);
...
void gl3dView::onSaveImage()
{
    ...
    QString FileName;
    if(!loc.isEmpty()) FileName = loc.first() + QDir::separator() + "gl3dView.png";
