...
void FormatTextOutput::updateColors(bool bOpaque)
{
    QPalette palette;
...
void FormatTextOutput::keyPressEvent(QKeyEvent *pEvent)
{
    bool bAlt = false;
    bool bCtrl = false;
...
void FormatTextOutput::showEvent(QShowEvent *pEvent)
{
...
void FormatTextOutput::setCharDimensions(int nHChar, int nVChar)
{
    m_nHChar = nHChar;
    m_nVChar = nVChar;
}
...
void FormatTextOutput::onAppendQText(QString const &sometext)
{
...
void FormatTextOutput::appendHtmlText(QString const &sometext)
{
    moveCursor(QTextCursor::End);
    insertHtml(sometext);
    moveCursor(QTextCursor::End);
...
void FormatTextOutput::appendEOL(int n)
{
    moveCursor(QTextCursor::End);
